  ...
  return (
    <PopoverRadix.Root>
      <PopoverRadix.Trigger
        title={dateFormatted}
        className={clsx(
          'h-10 w-10 lg:h-5 lg:w-5 rounded-xl lg:rounded-md border-2 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background dark:focus:ring-offset-zinc-900 focus:ring-offset-zinc-100 focus:ring-sky-600',
          {
            'bg-zinc-300 border-zinc-400 dark:bg-zinc-800 dark:border-zinc-900':
