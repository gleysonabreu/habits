...
export function Alert({ title, text, type }: AlertProps) {
  return (
    <div className={clsx('rounded border-s-4 p-4', {
      'dark:border-red-600 dark:bg-red-900 border-red-500 bg-red-50': type === 'danger',
      'dark:border-yellow-600 dark:bg-yellow-900 border-yellow-500 bg-yellow-50': type === 'warning',
      'dark:border-green-600 dark:bg-green-900 border-green-500 bg-green-50': type === 'success',
      'dark:border-blue-600 dark:bg-blue-900 border-blue-500 bg-blue-50': type === 'info',
    })}>
      <strong className={clsx('block font-medium ', {
